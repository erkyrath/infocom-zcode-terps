...
DISK:	BCS	DWRITE		; WRITE IF CARRY SET
	...
	LDA	FASTEN		; FAST-READ AVAILABLE? (LC-A)
	BEQ	SLOW		; USE SLOW CODE IF NOT (LC-A)
	LDA	FAST		; FAST-READ ENGAGED? (LC-A)
	BEQ	SLOW		; NO, USE SLOW (LC-A)

	JMP	DOFAST		; ELSE USE FAST-READ ROUTINES (LC-A)
