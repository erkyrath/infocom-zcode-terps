...
IOBUFF	EQU	MSTART		; PAGENG BUFFER

ZSTKBL	EQU	MSTART+$100	; Z-STACK  BOTTOM,LO  (1K STACK FOR EZIP)
ZSTKTL	EQU	ZSTKBL+$100	; TOP, LO
ZSTKBH	EQU	ZSTKBL+$200	; BOTTOM, HI
ZSTKTH	EQU	ZSTKBL+$300	; TOP, HI

NEXTPNT	EQU	MSTART+$500	; PAGING TABLES
PREVPNT	EQU	NEXTPNT+$80	
VPAGEH	EQU	PREVPNT+$80	
VPAGEL	EQU	VPAGEH+$80	

LOCALS	EQU	MSTART+$700	; LOCAL VARIABLE STORAGE (30 BYTES)
BUFSAV	EQU	LOCALS+$20	; AUXILIARY INPUT BUFFER (80 BYTES)

EZIP	EQU	MSTART+$800
ZBEGIN	EQU	EZIP+$2A00	; START OF PRELOAD
...
ZSCRWD	EQU	32	; SCREEN PARAMETER WORD ( "     "   "  )
	...
	; THESE ARE THE FLAGS & REGISTERS USED TO ACCESS THE 256K
	; EXPANSION RAM FOR THE C64 IF IT IS ATTACHED
...
;XSIZE	EQU	DBUFF+11	; (BYTE) SCREEN WIDTH FOR TESTS (LC-A)

RAND1	EQU	CHRMAX+1	; (BYTE) RANDOM #
SPLITF	EQU	CHRMAX+2	; (BYTE) WHICH WINDOW TO WRITE IN
RDTBL1	EQU	CHRMAX+3	; (WORD) READ TABLE 1 (ABSOLUTE- EZIP)
...
IOCHAR	EQU	LINCNT+2	; (BYTE) CHARACTER BUFFER
...
PSTAT	EQU	TABLEF+4	; (BYTE) PRINTER STATUS
...
;TOP	EQU	SAVSIZ+4	; (BYTE) HOLDS WTOP (LC-A)

NARGS	EQU	 SAVSIZ+4	; (BYTE) # ARGUMENTS
...
RNUM1	EQU	 NARGS+21	; (BYTE) FOR RANDOM - DON'T USE
RNUM2	EQU	 NARGS+22	; (BYTE) FOR RANDOM - DON'T USE

; THE REST OF THE VARIABLES (THAT WOULDN'T FIT) ARE AT THE END OF IO.ASM

LASTZP	EQU	RNUM2+1		; CHECK FOR OVER ZERO PAGE
