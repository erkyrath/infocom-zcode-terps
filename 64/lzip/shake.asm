	...
	; NOTE: WHEN MAKING THIS ALONE FOR SIDE 2 OF THE LZIP DISK 
	; (FASTCODE.BIN) XASM WILL MAKE A 512 BYTE .BIN FILE, USE
	; DDT TO CUT IT BACK TO THE APPROPRIATE 256 BYTE SIZE
	; DDT SHAKE.BIN
	; <CTRL-C>
	; SAVE 1 FASTCODE.BIN
