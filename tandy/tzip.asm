	TITLE	ZIP	Z-LANGUAGE INTERPRETER      TANDY 2000/557 VERSION
	...
	; 4) FIXED SAVE AND RESTORE BUGS - 8/10/84 RML
	; 5) FIXED STATUS LINE BUG ON RESTART - OCT-84/PHG
	; 
...
DATA_SG	SEGMENT	PARA
	...
	;GTBLKS
GAMFCB	DB	0,"PLANETFADAT",30 DUP(0)
SAVFCB	DB	0,"PLANETFASAV",30 DUP(0)
...
IDSTR	DB	"Tandy 1000/2000 Interpreter Version-D",0
DQUEST	DB	"Is your computer a Tandy 2000 (Y/N) ? ",0
...
NEWLIN	ENDP
	...
	; READ THE SETUP FILE
SSETUP	PROC	NEAR
	CALL	MINIT	;CLEAR AND CURSOR TO BOTTOM
	PRINT	DQUEST	;ASK IF 2000

	CALL	MCHRI	;GET CHARACTER
	CMP	AL,"N"	;NOT
	JE	IS557
	CMP	AL,"n"	;NOT
	JE	IS557
...
RESTRT	PROC
	...
	MOV	CX,PURBOT
	CALL	GTBLKS
	JMP	RESTRT1		; (5) SKIP CALL TO TSETUP
START1:	
