	...
	; 4) STATUS LINE BUG FIXED (ZORK II) - 07/24/84
	; 5) IMPLIMENTED SINGLE-DRIVE SAVE AND RESTORE -"F"-8/20/84
	;
	
	SUBTTL	STACK AND DATA SEGMENTS INITIALIZATION

ZVERSN	EQU	"F"		;ZIP VERSION NUMBER
...
SCPL	DB	78
SLPP	DB	24
STINIT	DB	16	; NUMBER OF CHARACTERS!!!
	DB	27,"[2J",27,"[0m",27,"[01;01H"
STRESET	DB	0
SBLINE	DB	15	; NUMBER OF CHARACTERS!!!
	DB	27,"[32;7m",27,"[01;01H"
SELINE	DB	12	; NUMBER OF CHARACTERS!!!!
	DB	27,"[0m",27,"["
SELINE1	DB	"25;01H"
SPINIT	DB	0
...
IDSTR	DB	"TI-DOS 2.0 Interpreter Version F",0
